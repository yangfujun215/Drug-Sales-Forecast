...
import torch
import pandas as pd
from train.data_loader import test_loader, drug_id
from train.load_data import hyperedge_index
from train.data_loader import scalers
...
# 保存为 Excel 文件
predicted_df.to_excel("../prediction/predicted_sales2.xlsx", index=False)
